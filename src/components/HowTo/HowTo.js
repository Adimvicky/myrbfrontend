  ...
  return (
    <div className={`bg-grey-100 px-20 py-12 text-dark-200`}>
      ...
      <div className="flex justify-between items-center mb-6">
        <h3 className="h3 text-dark-300">Browse help</h3>
      ...
      <div class="flex bg-white text-dark-200 p-6 py-0 shadow-light rounded">
        <div className="w-1/3 b-r-lighter">
          {
            howTos.map((howTo) => (
        ...
        <div className="w-2/3 flex-1 py-6 p-10">
